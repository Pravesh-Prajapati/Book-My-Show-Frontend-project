...
function Header() {
    ...
    // ===============context
    let getsearchmovie= useContext(searchcontext)
    // console.log(getsearchmovie.getmovie);
    
    let searchmovie = (e) => {
        let value = e.target.value
        setsearch(value)
        getsearchmovie.getmovie(e.target.value)
        // console.log(value);  
    }
    // ===================
    ...
    let logout = () => {
        ...
        // localStorage.setItem("bookmyshowuser", JSON.stringify("logout"))
    ...
    return (
        <>
                ...
                <div className="container">
                    <div className="navbar">
                        <div className='nav-left'>
                            ...
                            <div>
                                <input type="text" onChange={(e) => { searchmovie(e) }} placeholder='Search for Movies ,Events,Plays,Sports,and Activities' className='search' />
                            </div>
                        </div>
                            ...
                            <ul className='nav-list'>
                                ...
                                {!loginuser ?
                                    ...
                                    <>
                                       <Link to={"/signin"} >
                                            <li>
                                                <button className='btn1' style={{cursor:"pointer"}} onClick={logout}>Sign Out</button>
                                            </li>
                                        </Link>
                                        <h6 style={{color:"blue"}}>{loginuser.email}</h6>
                                    </>
                                }
                                <li>
                                    <button className='btn' onClick={() => { setsidebar(!sidebar) }}>&#9776;</button>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div className={`sidebar`}>
                {sidebar &&
                    <div className='overlay' style={{ cursor: "pointer", transition: "all 0.2s" }} onClick={() => { setsidebar(!sidebar) }}></div>
                }
                <div className={`sidebar-info ${sidebar ? "sidebar-active" : ""}`}>
                    <div className='sidebar-data'>
                        ...
                        <div className='login-sec'>
                            <div>
                                <h3>Unlock Special Offers & great benifits</h3>
                            </div>
                            <button>Login / Register</button>
                        </div>
                        <div >
                            <div className='notification-sec'>
                                <div className='sidebar-subdata'>
                                    <IoIosNotificationsOutline />
                                    <h3>Notification</h3>
                                </div>
                                <button className='btns'><MdKeyboardArrowRight /></button>
                            </div>
                            <div className='activity'>
                                <div className='activity-sec'>
                                    <TbShoppingBagSearch />
                                    <Link to={"/bookings"} className='sub-info' onClick={() => { setsidebar(!sidebar) }}>
                                        <h3>Your Orders</h3>
                                        <p>View All Your booking & Purchased</p>
                                    </Link>
                                    \
                                ...
                                <button className='btns btn-disabled'> <FaLock /></button>
                            </div>
                            <div className='activity'>
                                <div className='activity-sec'>
                                    <TbShoppingBagSearch />
                                    <div className='sub-info'>
                                        ...
                                        <p>Rented And Purchased Movie</p>
                                    </div>
                                </div>
                                <button className='btns btn-disabled'> <FaLock /></button>
                            </div>
                            <div className='activity'>
                                <div className='activity-sec'>
                                    <TbShoppingBagSearch />
                                    <div className='sub-info'>
                                        <h3>Play Credit Card</h3>
                                        <p>View Your Play Credit Card Detail and Offers</p>
                                    </div>
                                </div>
                                <button className='btns'><MdKeyboardArrowRight /></button>
                            ...
                            <div className='activity'>
                                <div className='activity-sec'>
                                    <TbShoppingBagSearch />
                                    <div className='sub-info'>
                                        <h3>Account And Setting</h3>
                                        <p>Location Payments Permission & More</p>
                                    </div>
                                </div>
                                <button className='btns btn-disabled'> <FaLock /></button>
                            </div>
